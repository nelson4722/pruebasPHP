...
function Footer()
{
	...
	$pacientes = mysqli_query($pacientes,$strConsulta);
	$fila = mysqli_fetch_array($pacientes,MYSQLI_ASSOC);
	...
	$historial = mysqli_query($historial,$strConsulta);
	$i=0;
        while (($fila = mysqli_fetch_array($historial, MYSQLI_ASSOC)) != NULL)
	{
